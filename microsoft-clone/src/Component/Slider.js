        ...
        <>
            <div className="slider flex flex-col-reverse md:flex-row bg-[#f2f2f2] mx-2">
                <div className="left flex flex-col justify-center items-center md:ml-10 md:items-baseline py-12 md:w-[50%]">
                    ...
                    <button className='text-white bg-black font-bold px-4 py-2 my-6 mx-5'>Shop Now ></button>
                </div>
                <div className="right md:w-[46%] w-52">
                    <img className='ml-16 w-[64rem] h-96  md:ml-12 md:h-80' src='/img/Canvas2.avif' alt='' />
